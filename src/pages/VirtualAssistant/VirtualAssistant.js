...
import { SpeechContext } from "../../App";

export default function VirtualAssistant({ data }) {
  /////////////////////////////////////////////////////////////////
  // <------------------------- STATE -------------------------> //
  /////////////////////////////////////////////////////////////////
  // time
  ...
  const handleMouseDown = async (e) => {
    ...
    await data.SpeechRecognition.startListening({
      continuous: false,
      language: "en-US",
    });
  };
  ...
  const handleMouseUp = async (e) => {
    ...
    await data.SpeechRecognition.stopListening();
  };
            ...
            >
              <div>
                ...
                <img
                  ...
                  src={data.listening ? micOn : micOff}
                />
              </div>
              {/* ///////////////////////////////////////////////////////////////// */}
              {/* <------------------------- LISTEN BTN --------------------------> */}
